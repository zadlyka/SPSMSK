								...
								<div class="panel-body">
									...
									<form class="form-horizontal form-bordered" id="submit">
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" id="nosurat" name="xnomor_surat" value="<?php echo $i['nomor_surat'];?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Tanggal Surat</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="tanggal_surat" name="xtanggal_surat" value="<?php echo $i['tanggal_surat'];?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Asal Surat</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="asalsurat" name="xasal_surat" value="<?php echo $i['asal_surat'];?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Perihal</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="perihal" name="xperihal" value="<?php echo $i['perihal'];?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Tanggal Diterima</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="tanggal" name="xtanggal" value="<?php echo $i['tanggal'];?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Jenis Surat</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="jenissurat" value="Surat Masuk" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">File</label>
												<div class="col-md-6 control-label" style="text-align: left;">
													<a href="<?php echo base_url().'suratmasuk/lakukan_download/'.$i['file_surat']?>">
							                        		<?php
								                        			if ($i['file_surat']!='') {
								                        				# code...
		...
		<script>
			$(document).ready(function(){
					...
					$('#submit').submit(function(e){
					    e.preventDefault(); 
					         $.ajax({
					             url:'<?php echo base_url().'suratmasuk/edit_arsip/'.$kode?>',
					             type:"post",
					             ...
					             success: function(data){
					                  alert("Berhasil.");
					                  window.location.replace("<?php echo base_url().'tu/arsipsuratmasuk'?>");
					           }
					         });
					    });
