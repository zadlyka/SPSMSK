								...
								<div class="panel-body">
									...
									<form class="form-horizontal form-bordered" id="submit">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" id="tujuansurat" name="xtujuan_surat" value="<?php echo $i['tujuan_surat'];?>" readonly="true">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" id="jenissurat" value="Surat Keluar" readonly="true">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">File</label>
												<div class="col-md-6 control-label" style="text-align: left;">
													<a href="<?php echo base_url().'suratkeluar/lakukan_downloads/'.$i['file_surat']?>" style="vertical-align: middle;">
							                        		<?php
								                        			if ($i['file_surat']!='') {
								                        				# code...
					    ...
					    e.preventDefault(); 
					         $.ajax({
					             ...
					             success: function(data){
					                  alert("Berhasil.");
					                  window.location.replace("<?php echo base_url().'tu/arsipsuratkeluar'?>");
					           }
					         });
					    });
