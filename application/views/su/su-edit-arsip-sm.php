								...
								<div class="panel-body">
									...
									<form class="form-horizontal form-bordered" id="submit">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" id="asalsurat" name="xasal_surat" value="<?php echo $i['asal_surat'];?>">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" id="jenissurat" value="Surat Masuk">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="fileupload fileupload-new" data-provides="fileupload">
														<div class="input-append">
															...
															<a href="<?php echo base_url().'suratmasuk/removefilearsips/'.$kode?>" class="btn btn-default">Remove</a>
														</div>
													</div>
												</div>
											</div>
					    ...
					    e.preventDefault(); 
					         $.ajax({
					             ...
					             success: function(data){
					                  alert("Berhasil.");
					                  window.location.replace("<?php echo base_url().'su/arsipsuratmasuk'?>");
					           }
					         });
					    });
