						...
						<div class="col-lg-12">
							<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title" style="margin-bottom: 20px;">Daftar Pengguna</h2>
										<div class="input-group input-search">
											<input type="text" class="form-control" name="keyword" id="keyword-search" placeholder="Masukan Username Atau Nama Pengguna..." onkeyup="search()">
								...
								<div class="panel-body">
										<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault" style="padding-top: 7px; padding-left: 0px;">Level User</label>
												<div>
													<select class="form-control mb-md" id="keyword-select" onchange="select()">
														<option>All</option>
														<option>Administrator Utama</option>
														<option>Administrator PTSP</option>
														<option>Administrator TU</option>
													</select>
												</div>
										</div>
										<div class="table-responsive">
											<table class="table table-bordered mb-none" id="pengguna" style="background-color: #ffffff;">
												<thead>
													<tr>
														<th>No</th>
														<th>Username</th>
												...
												<tbody>
													...
													<tr>
							                        	...
							                        	<td><?php echo $pic;?></td>
							                        	<td class="actions">
															<a href="<?php echo base_url().'su/daftarpenggunaubah/'.$id?>"><i class="fa fa-pencil"></i></a>
															<a href="<?php echo base_url().'pengguna/hapus_pengguna/'.$id?>" class="delete-row"><i class="fa fa-trash-o"></i></a>
														</td>
													</tr>
													</tr>
												<?php endforeach;?>
...
function search() {
		  ...
		  table = document.getElementById("pengguna");
