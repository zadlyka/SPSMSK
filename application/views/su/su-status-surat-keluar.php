											...
											<table class="table table-bordered mb-none" id="surat_masuk" style="background-color: #ffffff;">
												...
												<tbody>
													...
													<tr>
							                        	...
							                        	<td class="actions">
															<a href="<?php echo base_url().'su/statussuratkeluarubah/'.$kode?>"><i class="fa fa-pencil"></i></a>
															<a href="<?php echo base_url().'suratkeluar/hapus_surats/'.$kode?>" class="delete-row"><i class="fa fa-trash-o"></i></a>
														</td>
													</tr>
												<?php endforeach;?>
												</tbody>
