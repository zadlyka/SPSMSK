											...
											<table class="table table-bordered mb-none" style="background-color: #ffffff;" id="surat_masuk">
												...
												<tbody>
													...
													<tr>
							                        	...
							                        	<td><a href="<?php echo base_url().'suratmasuk/lakukan_download/'.$file_surat?>">
							                        		<?php
								                        			if ($i['file_surat']!='') {
								                        				# code...
							                        	...
							                        	<td class="actions">
															<a href="<?php echo base_url().'su/editarsipsm/'.$kode?>"><i class="fa fa-pencil"></i></a>
															<a href="<?php echo base_url().'suratmasuk/hapus_arsips/'.$kode?>" class="delete-row"><i class="fa fa-trash-o"></i></a>
														</td>
													</tr>
													<?php endforeach;?>
												</tbody>
