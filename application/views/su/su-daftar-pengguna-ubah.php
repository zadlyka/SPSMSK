							...
							<section class="panel">
								...
								<div class="panel-body">
													<?php foreach ($data->result_array() as $i) :
								                       ...
								                       $pic=$i['pic'];
								                    ?>
									<form class="form-horizontal form-bordered" action="<?php echo base_url().'pengguna/edit_pengguna/'.$id?>" method="post">
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Username</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="username" readonly="true" name="xusername" required value="<?php echo $i['username'];?>">
												</div>
												<div class="col-md-3">
													<p style="teqxt-align: center; color: #ff3d3d; font-weight: bold;"><?php echo $this->session->flashdata('username');?></p>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Password</label>
												<div class="col-md-6">
													<input type="password" class="form-control" id="password" name="xpassword" required value="<?php echo $i['password'];?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Nama Lengkap</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="nama" name="xnama" required value="<?php echo $i['nama'];?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Level User</label>
												<div class="col-md-6">
													<select class="form-control mb-md" name="xpic">
															<option
																<?php 
																	if ($i['pic'] == 'Administrator Utama') {
																		# code...
																		echo "selected";
																	}else{
																		echo "";
																 ...
																 ?>
															>Administrator Utama</option>
															<option <?php 
																	if ($i['pic'] == 'Administrator PTSP') {
																		# code...
																		echo "selected";
																	}else{
																		echo "";
																 ...
																 ?>
														    >Administrator PTSP</option>
															<option
																<?php 
																	if ($i['pic'] == 'Administrator TU') {
																		# code...
																		echo "selected";
																	}else{
																		echo "";
