											...
											<table class="table table-bordered mb-none" style="background-color: #ffffff;" id="surat_keluar">
												...
												<tbody>
													...
													<tr>
							                        	...
							                        	<td class="actions">
															<a href="<?php echo base_url().'su/editarsipsk/'.$kode?>"><i class="fa fa-pencil"></i></a>
															<a href="<?php echo base_url().'suratkeluar/hapus_arsips/'.$kode?>" class="delete-row"><i class="fa fa-trash-o"></i></a>
														</td>
													</tr>
													<?php endforeach;?>
												</tbody>
