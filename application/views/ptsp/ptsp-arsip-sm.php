	...
	<body>
						...
						<div class="col-lg-12">
							<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title" style="margin-bottom: 20px;">Arsip Surat Masuk</h2>
								...
								<div class="panel-body">
											...
											<table class="table table-bordered mb-none" style="background-color: #ffffff;" id="surat_masuk">
												<thead>
													<tr>
														<th>No</th>
												...
												<tbody>
													...
													<tr>
							                        	...
							                        	<td>
							                        		<a href="<?php echo base_url().'suratmasuk/lakukan_download/'.$file_surat?>">
							                        		<?php
								                        			if ($i['file_surat']!='') {
								                        				# code...
		...
		<script>
			...
			function exportTableToExcel(){
				$('#surat_masuk tr').find('td:eq(7),th:eq(7)').remove();
				$("#surat_masuk").table2excel({
        		filename: 'Arsip Surat Masuk',
