		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="<?php echo base_url().'ptsp'?>" class="logo">
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info">
								...
								<span class="role">Administrator PTSP</span>
							</div>
						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									<li>
										<a href="<?php echo base_url().'ptsp'?>">
											<i class="fa fa-home" aria-hidden="true"></i>
											<span>Beranda</span>
										</a>
									</li>
									<li class="nav-active">
										<a href="<?php echo base_url().'ptsp/inputsuratmasuk'?>">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="<?php echo base_url().'ptsp/status'?>">
													 Surat Masuk
												</a>
											</li>
											<li>
												<a href="<?php echo base_url().'ptsp/statussk'?>">
													 Surat Keluar
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="<?php echo base_url().'ptsp/arsipsuratmasuk'?>">
													 Surat Masuk
												</a>
											</li>
											<li>
												<a href="<?php echo base_url().'ptsp/arsipsuratkeluar'?>">
													 Surat Keluar
												</a>
											</li>
										</ul>
						...
						<div class="col-lg-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form class="form-horizontal form-bordered" action="<?php echo base_url().'suratmasuk/simpan_surat'?>" method="post">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" iid="asal_surat" name="xasal_surat" required>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Tahun Diterima</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="tahun" name="xtahun" value="<?php $tanggal=getdate(); echo $tanggal['year'];?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="inputDefault">Nama Petugas PTSP</label>
												<div class="col-md-6">
													<input type="text" class="form-control" id="petugas_ptsp" name="xpetugas_ptsp" readonly="readonly" value="<?php echo $c['nama'];?>">
												</div>
											</div>
