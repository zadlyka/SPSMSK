...
<html class="fixed">
	...
	<body>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="chart-data-selector" id="salesSelectorWrapper">
												<div>
													<h2 style="text-align: center;">Grafik Jumlah Surat Masuk Tahun <span><?php echo $year;?></span></h2>
												</div>
												<br>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Jumlah Surat Masuk Bulan Ini</h4>
														<div class="info">
									...
									<section class="panel panel-featured-left panel-featured-secondary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Jumlah Surat Masuk Tahun Ini</h4>
														<div class="info">
		...
		<!-- Theme Custom -->
		<script src="<?php echo base_url(); ?>assets/javascripts/theme.custom.js"></script><script type="text/javascript">
			function ubahgrafik() {
				// body...
				var surat = document.getElementById("select-surat").value;
				if (surat == 'Surat Masuk') {
					window.location.replace("<?php echo base_url().'ptsp/beranda'?>");
				}else{
					window.location.replace("<?php echo base_url().'ptsp/beranda1'?>");
				}
